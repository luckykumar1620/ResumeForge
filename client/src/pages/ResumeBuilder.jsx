...
const ResumeBuilder = () => {
    ...
    const sections=[
        ...
        {id:"prjects",name:"Projects",icon:FolderIcon},
            ...
            <div className='grid lg:grid-cols-12 gap-8'>
              ...
              <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
                ...
                p-6 pt-1 '>
                    ...
                    <hr className='absolute top-0 right-0 left-0  border-2
                    border-gray-200'/>
                   ...
                   border-gray-300 py-1'>
                    ...
                    <div className='flex items-center'>
                       { activeSectionIndex !==0 && (
                        ...
                        max(prevIndex-1,0))} className='flex items-center gap-1 p-3 rounded-lg
                        ...
                        <button onClick={()=>setActiveSectionIndex((prevIndex)=>Math.
                        min(prevIndex+1,sections.length-1))} className={`flex items-center gap-1 
                        p-3 rounded-lg text-sm font-medium text-gray-600 hover:
                        bg-gray-50 transition-all ${activeSectionIndex===sections.length-1 && 'opacity-50'}`}
