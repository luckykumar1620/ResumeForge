...
const Dashboard = () => {
    ...
    const deleteResume=async(resumeId)=>{
        ...
        try {
            const confirm=window.confirm("Are you sure you wan to delete this resume?")
        if(confirm){
    ...
    <div>
     <div className='max-w-7xl mx-auto px-4 py-8'>
        ...
        <div className='flex gap-4'>
           ...
           border-slate-300 group hover:border-indigo-500 shadow-lg transition-all 
           ...
           justify-center rounded-lg gap-2 text-slate-600 border border-dashed 
           border-slate-300 group hover:border-purple-500 shadow-lg transition-all 
           duration-300 cursor-pointer'>
        ...
        <div className='grid grid-cols-2 sm:flex flex-wrap gap-4'>
           {allResumes.map((resume,index)=>{
            ...
            return (
                <button key={index} onClick={()=>navigate(`/app/builder/${resume._id}`)} className='group relative w-full sm:max-w-36 h-48 flex 
                flex-col items-center justify-center rounded-lg gap-2 border hover:
                shadow-lg transition-all duration-300 cursor-pointer ' style={{background:
                    `linear-gradient(135deg, ${baseColor}10,${baseColor}40)`,borderColor:
                    baseColor + '40'
                }}>
                 ...
                 group-hover:flex items-center hidden'>
                  <TrashIcon onClick={()=>deleteResume(resume._id)} className='size-7 p-1.5
                   hover:bg-white/50 rounded text-slate-700
                  transition-colors'/>
        ...
        {showCreateResume && (
            ...
            z-10 flex items-center justify-center '>
                ...
                max-w-sm  p-6'>
                    ...
                    <input onChange={(e)=>setTitle(e.target.value)} value={title} type="text" placeholder='Enter resume title' className='w-full px-4 py-2
                    mb-4 focus:border-green-600 ring-green-600' required />
        ...
        {showUploadResume && (
            ...
            z-10 flex items-center justify-center '>
                ...
                max-w-sm  p-6'>
                    ...
                    <button disabled={isLoading} className='w-full py-2 bg-green-600 text-white rounded hover:bg-green-700
