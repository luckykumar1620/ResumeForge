  ...
  return (
    ...
    <div id='testimonials' className='flex flex-col items-center my-10 scroll-mt-12'>
      ...
      <div className="flex items-center gap-2 text-sm text-green-800 bg-green-400/10  rounded-full px-6 py-1.5">
        ...
        <Title title="Don't just take our words " description="Here what our users say about us.
        We are always looking for ways to improve if you have a positive experience with us,leave a review."/>
    </div>
